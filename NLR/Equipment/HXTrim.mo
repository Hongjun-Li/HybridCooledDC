...
model HXTrim
 ...
 //Dynamics
  ...
  parameter Real lValPum = 0.0001
    ...
    annotation(Dialog(group="Pump"));
  Modelica.Blocks.Interfaces.RealOutput powPum(each final quantity="Power",
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow pumCHW(
    ...
    dp_nominal=6000)   "Chilled water pump"   annotation (Placement(
        transformation(
        extent={{8,-8},{-8,8}},
        rotation=0,
        origin={-12,-20})));
  Modelica.Blocks.Interfaces.RealInput uCHWpum
    annotation (Placement(transformation(extent={{-140,-60},{-100,-20}})));
equation
  connect(chiPar.port_a2, val6.port_a) annotation (Line(points={{-40,24},{-26,
          24},{-26,-20},{-30,-20}}, color={0,127,255}));
  connect(pumCHW.port_b, val6.port_a)
    annotation (Line(points={{-20,-20},{-30,-20}}, color={0,127,255}));
  connect(pumCHW.port_a, val5.port_b)
    annotation (Line(points={{-4,-20},{40,-20}}, color={0,127,255}));
  connect(uCHWpum, pumCHW.m_flow_in) annotation (Line(points={{-120,-40},{-24,
          -40},{-24,-4},{-12,-4},{-12,-10.4}}, color={0,0,127}));
  connect(pumCHW.P, powPum) annotation (Line(points={{-20.8,-12.8},{-22,-12.8},
          {-22,-40},{110,-40}}, color={0,0,127}));
  connect(pumCHW.port_a, senTem.port_b) annotation (Line(points={{-4,-20},{6,
          -20},{6,6},{4,6},{4,24},{8,24}}, color={0,127,255}));
