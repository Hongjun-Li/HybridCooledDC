...
partial model PartialDataCenter
 ...
 // WSE parameters
  ...
  replaceable
    ...
    annotation (Placement(transformation(extent={{0,20},{12,34}})));
  ...
  Buildings.Fluid.HeatExchangers.CoolingTowers.YorkCalc cooTow[numChi](
    ...
    each PFan_nominal=18000) "Cooling tower"
...
equation
  connect(chiWSE.port_b2, TCHWSup.port_a)
    annotation (Line(
      points={{0,22.8},{-10,22.8},{-10,0},{-14,0}},
      color={0,127,255},
      thickness=0.5));
  connect(chiWSE.port_b1, TCWRet.port_a)
    annotation (Line(
      points={{12,31.2},{40,31.2},{40,60},{82,60}},
      color={0,127,255},
      thickness=0.5));
  ...
  connect(senRelPre.port_b, ahu.port_b1)
    annotation (Line(points={{10,-28},{30,-28},{30,-114},{20,-114}},
  ...
  connect(chiWSE.port_b1, TCWRet.port_a)
   ...
   for i in 1:numChi loop
    ...
    connect(pumCW[i].port_b, chiWSE.port_a1)
      annotation (Line(
        points={{-50,90},{-50,64},{-12,64},{-12,31.2},{0,31.2}},
        color={0,127,255},
        thickness=0.5));
    connect(chiOn[i].y, chiWSE.on[i])
      annotation (Line(
        points={{-109,140},{-80,140},{-80,32.32},{-0.96,32.32}},
        color={255,0,255}));
  ...
  connect(wseOn.y, chiWSE.on[numChi + 1])
    annotation (Line(
      points={{-109,110},{-80,110},{-80,32.32},{-0.96,32.32}},
      color={255,0,255}));
  ...
  connect(TCHWSup.T, cooTowSpeCon.TCHWSup)
    annotation (Line(
      points={{-20,6.6},{-20,54},{-146,54},{-146,94},{-178,94},{-178,171.778},{
          -172,171.778}},
      color={0,0,127}));
  connect(chiWSE.TSet, TCHWSupSet.y)
    annotation (Line(
      points={{-0.96,34.56},{-20,34.56},{-20,52},{-230,52},{-230,160},{-239,160}},
      color={0,0,127}));
  ...
  connect(senRelPre.port_a, ahu.port_a1)
    annotation (Line(
      points={{-10,-28},{-14,-28},{-14,-114},{0,-114}},
      color={0,127,255},
      thickness=0.5));
  ...
  connect(TCHWRet.port_a, ahu.port_b1)
    annotation (Line(
      points={{38,0},{42,0},{42,-114},{20,-114}},
      color={0,127,255},
      thickness=0.5));
  ...
  connect(gai1.u, senRelPre.p_rel)
    annotation (Line(points={{-198,-60},{0,-60},{0,-19}}, color={0,0,127}));
