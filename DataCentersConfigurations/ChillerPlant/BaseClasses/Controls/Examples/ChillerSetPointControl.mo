within DataCentersConfigurations.ChillerPlant.BaseClasses.Controls.Examples;
model ChillerSetPointControl
  ...
  DataCentersConfigurations.ChillerPlant.BaseClasses.Controls.TrimAndRespond triAndRes(
    yEqu0=0.1,
    uTri=0.8,
    yDec=-0.03,
    yInc=0.03,
  ...
  DataCentersConfigurations.ChillerPlant.BaseClasses.Controls.LinearPiecewiseTwo
    linPieTwo(
    x0=0,
    x2=1,
    y20=273.15 + 12.78,
