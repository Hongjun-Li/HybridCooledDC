...
model CDU "Heat exchanger"
  ...
  Modelica.Blocks.Interfaces.RealInput TSet(
    ...
    displayUnit="degC") if use_controller "Temperature setpoint for port_b2"
...
public
  Modelica.Blocks.Interfaces.RealInput activate if use_controller annotation (
      Placement(transformation(extent={{-140,64},{-100,104}}),
...
equation
  ...
  connect(v8.port_b, hex.port_a1)
    annotation (Line(points={{-20,6},{-10,6}}, color={0,127,255}));
  connect(port_a1, v8.port_a) annotation (Line(points={{-100,60},{-38,60},{-38,
          6},{-32,6}}, color={0,127,255}));
  connect(activate, v8.y)
    annotation (Line(points={{-120,84},{-26,84},{-26,13.2}}, color={0,0,127}));
  connect(thrWayVal1.y, con.y)
    annotation (Line(points={{-50,-14},{-50,40},{-59,40}}, color={0,0,127}));
  connect(thrWayVal1.port_2, hex.port_b2) annotation (Line(points={{-60,-26},{
          -64,-26},{-64,-6},{-10,-6}}, color={0,127,255}));
  connect(thrWayVal1.port_1, hex.port_b2) annotation (Line(points={{-40,-26},{
          -34,-26},{-34,-6},{-10,-6}}, color={0,127,255}));
  connect(thrWayVal1.port_3, port_a2) annotation (Line(points={{-50,-36},{-50,
